...
function clear($nb){
    ...
    for($i=0; $i<=$nb; $i++){
        ...
        $PDO = new PDO($DB_DSN, $DB_USER, $DB_PASS);
        $req = $PDO -> prepare("DELETE FROM `forum` WHERE id=:id");
        $req -> execute(array(
            "id" => $todel,
        ));
    ...
    <form method="post"><br>
        ...
        if(!empty($_POST['RELOAD'])){
            ...
            if(!empty($_POST['texte'])){
                ...
                if(str_contains($_POST['texte'], "!clear ")){
                    $len = strlen($_POST['texte']);
                    $tab = str_split($_POST['texte']);
...
<fieldset>
    ...
    <p>
        ...
        <input type="submit" class="chatbutton" value="BAN"></input><br>
    </p>
    ...
    <form method="post">
        <p>
            ...
            <input type="submit" class="chatbutton" value="ADD"></input>
        </p>
